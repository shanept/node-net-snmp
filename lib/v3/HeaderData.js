  ...
  Object.defineProperties(this, {
    ...
    msgFlags: {
      set: function (value) {
        ...
        if (value > (Constants.BitwiseFlags.Auth + Constants.BitwiseFlags.Priv +
...
HeaderData.prototype.fromBuffer = function (buffer) {
  buffer.readSequence();

  this.msgID = buffer.readInt();
  this.msgMaxSize = buffer.readInt();
  this.msgFlags = buffer.readString();
  this.msgSecurityModel = buffer.readInt();
};
...
HeaderData.prototype.toBuffer = function (buffer) {
  ...
  buffer.writeInt(this.msgFlags, Ber.OctetString); // must be int, encoded as string
