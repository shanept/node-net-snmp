...
USM.prototype.generateResponseMessage = function(options) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        if (securityStateReference !== null) {
            ...
            reject (new Error('Expected username for the User-based Security Model - none provided.'));
        }
        ...
        if (must_authenticate) {
            ...
            try {
                this._performDiscovery (function () {
                    _afterTimeWindowCb (resolve, reject);
                });
            } catch (error) {
                reject(error);
            }
    ...
    function _afterTimeWindowCb (resolve, reject) {
        /**
        ...
        if (must_authenticate) {
            try {
                this._performAuthentication (scopedPDUData, usmUserAuthKeyLocalized, securityParameters);
            } catch (error) {
                reject (error);
                return;
            }
