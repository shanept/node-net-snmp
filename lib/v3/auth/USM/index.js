...
USM.prototype.generateResponseMsg = function(options) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        _afterTimeWindowCb (options, resolve, reject);
    });
    ...
    function _afterTimeWindowCb (usmUserOptions, resolve, reject) {
         ...
         */
        securityParameters.msgUserName = options.username;
        ...
        if (must_authenticate) {
            try {
                me._performAuthentication (scopedPDUData, usmUserAuthKeyLocalized, securityParameters);
            } catch (error) {
                reject (error);
                return;
            }
